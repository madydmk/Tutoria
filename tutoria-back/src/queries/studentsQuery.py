...
def resolve_create_student(info):
    new_student = Students(firstName = info.firstName, lastName = info.lastName, address = info.adr, cp = info.cp, mail = info.mail, tel = info.tel, schoolId = info.schoolId, cfaId = info.cfaId, enterpriseId = info.enterpriseId)
